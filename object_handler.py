...
class ObjectHandler:
    def __init__(self, game):
        self.game = game
        self.sprite_list = []
        self.npc = NPC(game, path.join(path.dirname(__file__,),'resources/sprites/animated/enemy.png'), NPC_POS[0], 0.9, 0.1, 180)
        self.key = SpriteObject(game, path.join(path.dirname(__file__,),'resources/sprites/static/key.png'), KEY_POS[0], 0.3, 0.7)
