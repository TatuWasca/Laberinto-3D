...
class Menu:
    def __init__(self, game):
        self.game = game
        self.background_image = pg.image.load(path.join(path.dirname(__file__), 'resources/textures/background.png')).convert()
        self.go_image = pg.image.load(path.join(path.dirname(__file__), 'resources/textures/game_over.png')).convert_alpha()
...
class MainMenu(Menu):
    def __init__(self, game):
        ...
        pg.mixer.music.load(path.join(path.dirname(__file__), MENU_MUSIC))
